...
global.owner = process.env.OWNER_NUMBER  || '22891983438' ;  // ADD YOUR NUMBER WITHOUT +
    
module.exports = {
SESSION_ID: process.env.SESSION_ID || 'VAJIRA-MD=TdNigQTS#x7A0ROrlPFVysyI7dSWzNxYjUnUWTm3bAq_UhgQdrvg' ,
